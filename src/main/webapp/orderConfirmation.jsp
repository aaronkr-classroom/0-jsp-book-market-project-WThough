	...
	<div class="py-5">
		...
		<%
			...
			if (cartList==null)
				...
				for (int i=0; i < cartList.size(); i++){ //상품리스트 하나씪 출력하기
		...
		<a href="./ShippingInfo.jsp?cartId=<%=shipping_cartId %>" class="btn btn-secondary" role="botton"> 이전 </a>
